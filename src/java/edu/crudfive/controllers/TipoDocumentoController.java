...
import edu.crudfive.modelo.persistencia.TipoDocumentoFacade;
...
public class TipoDocumentoController implements Serializable {
    ...
    @EJB
    private edu.crudfive.modelo.persistencia.TipoDocumentoFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/edu/crudfive/mensajes/Bundle").getString("TipoDocumentoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/edu/crudfive/mensajes/Bundle").getString("TipoDocumentoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/edu/crudfive/mensajes/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/edu/crudfive/mensajes/Bundle").getString("TipoDocumentoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/edu/crudfive/mensajes/Bundle").getString("PersistenceErrorOccured"));
        }
    }
